...
const Athletes = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:65535/name-position-team")
      .then((res) => {
    ...
    <Container style={{ marginTop: "20px" }}>
      <Row>
        ...
        <Col xs={2} style={addButtonStyle}>
          {athletes.length !== 0 && (
            <Button variant="primary" onClick={() => setShowAddAthlete(true)}>
              Add Athlete
            </Button>
          )}
        </Col>
            ...
            <tr>
              <th>
                ...
                <div style={sortButtonStyle}>
                  <ArrowDownUp
                    id={sortDir.name === ASC ? "name-up" : "name-down"}
                    onClick={handleSort}
                  />
                </div>
              </th>
              <th>
                <div style={thStyle}>Position</div>
                <div style={sortButtonStyle}>
                  <ArrowDownUp
                    id={
                      sortDir.position === ASC ? "position-up" : "position-down"
                    }
                    onClick={handleSort}
                  />
                </div>
              ...
              <th>
                <div style={thStyle}>Team</div>
                <div style={sortButtonStyle}>
                  <ArrowDownUp
                    id={sortDir.team === ASC ? "team-up" : "team-down"}
                    onClick={handleSort}
                  />
                </div>
              </th>
